...
const Footer = () => {
    return (
        <div className='spacialBackGround'>
            <div className='w-4/5 mx-auto'>
                <footer className="footer justify-items-center py-10 md:grid-cols-6 md:p-10 text-white grid-cols-2">
                    <aside>
                        <img className='w-36' src={footLogo} alt="" />
                    ...
                    <nav>
                        <header className="font-bold text-xl text-white">SOLUTIONS</header>
                    ...
                    <nav>
                        <header className="font-bold text-xl text-white">RESOURCES</header>
